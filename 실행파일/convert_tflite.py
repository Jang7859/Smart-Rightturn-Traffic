...
flags.DEFINE_string('weights', './checkpoints/128', 'path to weights file')
flags.DEFINE_string('output', './checkpoints/128.tflite', 'path to output')
flags.DEFINE_integer('input_size', 128, 'path to output')

...
flags.DEFINE_string('weights', './data/128.weights', 'path to weights file')
flags.DEFINE_string('output', './checkpoints/128', 'path to output')
flags.DEFINE_boolean('tiny', True, 'is yolo-tiny or not')
flags.DEFINE_integer('input_size', 128, 'define input size of export model')
